...
analyze.missed = function(betas, num.params,
...
for (i in 1:length(num.p)) {
  for (j in 1:num.sims) {
    ...
    data = simulate.data(num.p = num.p[i])
...
prcts1 = analyze.missed(fit1$coefficients, num.params = 50)
```
