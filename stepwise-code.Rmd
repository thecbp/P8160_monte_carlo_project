...
analyze.missed = function(betas, num.p,
...
for (i in 1:length(num.p)) {
  for (j in 1:num.sims) {
    ...
    models = c(models, forward.model)
    print(paste("Simulation", j, "of", "p =", num.p[i], "done!"))
  }
}
```
...
data1 = simulate.data(num.p = 101)
fit1 = create.forward.model(data1)
prcts1 = analyze.missed(fit1$coefficients, num.p = 101)
```
