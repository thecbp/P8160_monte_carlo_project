...
```{r plotting-task1 }
just.1 = sim1 %>% filter(c == 1)
ggplot(data = just.1, aes(x = prct.wai)) + 
  geom_density(fill = "red") 

just.2 = sim1 %>% filter(c == 2)
ggplot(data = just.2, aes(x = prct.wai)) + 
  geom_density(fill = "blue") 

just.3 = sim1 %>% filter(c == 3)
ggplot(data = just.3, aes(x = prct.wai)) + 
